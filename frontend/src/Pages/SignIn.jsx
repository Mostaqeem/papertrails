  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        // "http://172.17.231.72:8003/api/accounts/login/",
      ...
      if (response.status === 200) {
        ...
        // Store permitted departments from the backend response
        const permittedDepartments = userData.permitted_departments || [];
        
        // Create complete user data object
        const completeUserData = {
          ...userData,
          permitted_departments: permittedDepartments
        };
