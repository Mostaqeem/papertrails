...
export const getUserData = () => {
  try {
    ...
    const departmentPermissions = localStorage.getItem('userDepartmentPermissions');
    
    const parsedUserData = userData ? JSON.parse(userData) : null;
    if (parsedUserData) {
      parsedUserData.department_permissions = departmentPermissions ? JSON.parse(departmentPermissions) : [];
    }
